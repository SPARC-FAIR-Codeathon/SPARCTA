  ...
  <div class="container">
    ...
    <div v-if="showModal" class="modal">
      <div class="modal-content">
        ...
        <p>
          Welcome to SPARCTA! To start annotating, select the annotation type
          and hold press SHIFT <br /><br />
          <span style="font-size: 10px"
            >(Not the most ideal way but it works for now, we'll implement
            something easily in the future because of the time
            constraint).</span
          >
        </p>
      </div>
    ...
    return {
      ...
      tools: [
        ...
        },
        {
          ...
          action: this.downloadAnnotations,
        },
        {
        ...
        {
          name: "rect",
          title: "Annotate in rectangle",
          icon: "/icon/rect.png",
          action: () => this.setDrawingTool("rect"),
        },
        {
          name: "ellipse",
          title: "Annotate in ellipse",
          icon: "/icon/ellipse.png",
          action: () => this.setDrawingTool("ellipse"),
        },
        {
          name: "polygon",
          title: "Annotate in polygon",
          icon: "/icon/polygon.png",
          action: () => this.setDrawingTool("polygon"),
        },
        {
          name: "freehand",
          title: "Annotate in freehand",
          icon: "/icon/freehand.png",
          action: () => this.setDrawingTool("freehand"),
        },
        {
          name: "deleteAllAnnotations",
          title: "Delete all annotations",
          icon: "/icon/remove_all.png",
          action: this.deleteAllAnnotations,
        },
      ],
    };
  },
